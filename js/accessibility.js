...
(function () {
  ...
  function applySettings() {
    ...
    /* Only set a real filter. An identity filter still traps position:fixed (lightbox). */
  ...
  var ICONS = {
    ...
    accessibility: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2a2 2 0 1 1 0 4 2 2 0 0 1 0-4zm-1.5 5h3l1.2 5.8 2.8.5-.4 1.9-3.4-.6-.9-4.1H12L9.8 18.2A3.5 3.5 0 1 1 8 16.6l1.5-6.1H9.5V7zM7.5 17.5a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"/></svg>'
  };
